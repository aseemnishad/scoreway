        ...
        <div className="row d-flex align-items-center">
          ...
          <div className="col-md-7 col-lg-6 order-first order-md-2">
            <div className="hero-16-txt">
              {/* Title */}
              <h2 className="h2-sm">Scoreway</h2>
              {/* Text */}
              <p className="p-xl">
                Scoreway is a focused learning app designed to help aspirants
                clear the UGC NET exam effectively. It promotes learning by
                solving previous years’ questions, helping users identify
                important topics, strengthen core concepts, and improve time
                management through regular practice—ultimately boosting
                confidence to complete the exam on time and succeed
              </p>
              {/* STORE BADGES */}
