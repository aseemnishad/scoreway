        ...
        <div className="row d-flex align-items-center">
          ...
          <div className="col-md-7 col-lg-6 order-first order-md-2">
            <div className="hero-2-txt white-color wow fadeInLeft">
              {/* Title */}
              <h2 className="h2-xl">Letsvoo - Study Abroad App</h2>
              {/* Text */}
              <p className="p-xl">
                Getting connected and being knowledgeable opens up a world of
                possibilities
              </p>
              {/* STORE BADGES */}
              <div className="stores-badge">
                ...
                <a
                  target={"_blank"}
                  href="https://play.google.com/store/apps/details?id=com.letsvoo"
                  className="store"
                >
                  <img
